...
from core.tools import crypto_scan_tool, analyze_host_opportunities_tool
...
def main():
    ...
    agent_orchestrator.tool_registry.register_tool("analyze_host_opportunities", analyze_host_opportunities_tool)
